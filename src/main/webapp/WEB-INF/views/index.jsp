...
<head>
    ...
    <!-- The styles -->
    <link id="bs-css" href="../others/charisma/css/bootstrap-cerulean.min.css" rel="stylesheet">

    <link href="../others/charisma/css/charisma-app.css" rel="stylesheet">
    <link href='../others/charisma/bower_components/fullcalendar/dist/fullcalendar.css' rel='stylesheet'>
    <link href='../others/charisma/bower_components/fullcalendar/dist/fullcalendar.print.css' rel='stylesheet' media='print'>
    <link href='../others/charisma/bower_components/chosen/chosen.min.css' rel='stylesheet'>
    <link href='../others/charisma/bower_components/colorbox/example3/colorbox.css' rel='stylesheet'>
    <link href='../others/charisma/bower_components/responsive-tables/responsive-tables.css' rel='stylesheet'>
    <link href='../others/charisma/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css' rel='stylesheet'>
    <link href='../others/charisma/css/jquery.noty.css' rel='stylesheet'>
    <link href='../others/charisma/css/noty_theme_default.css' rel='stylesheet'>
    <link href='../others/charisma/css/elfinder.min.css' rel='stylesheet'>
    <link href='../others/charisma/css/elfinder.theme.css' rel='stylesheet'>
    <link href='../others/charisma/css/jquery.iphone.toggle.css' rel='stylesheet'>
    <link href='../others/charisma/css/uploadify.css' rel='stylesheet'>
    <link href='../others/charisma/css/animate.min.css' rel='stylesheet'>

    <!-- jQuery -->
    <script src="../others/charisma/bower_components/jquery/jquery.min.js"></script>
    ...
    <!-- The fav icon -->
    <link rel="shortcut icon" href="../others/charisma/img/favicon.ico">
...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.jsp"> <img alt="Charisma Logo" src="../others/charisma/img/logo20.png" class="hidden-xs"/>
            ...
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="../others/charisma/login.html">Logout</a></li>
                </ul>
            </div>
            <!-- user dropdown ends -->
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="../others/charisma/ui.html"><i class="glyphicon glyphicon-eye-open"></i><span> UI Features</span></a>
                        </li>
                        <li><a class="ajax-link" href="../others/charisma/form.html"><i
                                    class="glyphicon glyphicon-edit"></i><span> Forms</span></a></li>
                        <li><a class="ajax-link" href="../others/charisma/chart.html"><i class="glyphicon glyphicon-list-alt"></i><span> Charts</span></a>
                        </li>
                        <li><a class="ajax-link" href="../others/charisma/typography.html"><i class="glyphicon glyphicon-font"></i><span> Typography</span></a>
                        </li>
                        <li><a class="ajax-link" href="../others/charisma/gallery.html"><i class="glyphicon glyphicon-picture"></i><span> Gallery</span></a>
                        </li>
                        <li class="nav-header hidden-md">Sample Section</li>
                        <li><a class="ajax-link" href="../others/charisma/table.html"><i
                        ...
                        <li><a class="ajax-link" href="../others/charisma/calendar.html"><i class="glyphicon glyphicon-calendar"></i><span> Calendar</span></a>
                        </li>
                        <li><a class="ajax-link" href="../others/charisma/grid.html"><i
                                    class="glyphicon glyphicon-th"></i><span> Grid</span></a></li>
                        <li><a href="../others/charisma/tour.html"><i class="glyphicon glyphicon-globe"></i><span> Tour</span></a></li>
                        <li><a class="ajax-link" href="../others/charisma/icon.html"><i
                                    class="glyphicon glyphicon-star"></i><span> Icons</span></a></li>
                        <li><a href="../others/charisma/error.html"><i class="glyphicon glyphicon-ban-circle"></i><span> Error Page</span></a>
                        </li>
                        <li><a href="../others/charisma/login.html"><i class="glyphicon glyphicon-lock"></i><span> Login Page</span></a>
                        </li>
                    </ul>
...
<script src="../others/charisma/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

<!-- library for cookie management -->
<script src="../others/charisma/js/jquery.cookie.js"></script>
<!-- calender plugin -->
<script src='../others/charisma/bower_components/moment/min/moment.min.js'></script>
<script src='../others/charisma/bower_components/fullcalendar/dist/fullcalendar.min.js'></script>
<!-- data table plugin -->
<script src='../others/charisma/js/jquery.dataTables.min.js'></script>

<!-- select or dropdown enhancer -->
<script src="../others/charisma/bower_components/chosen/chosen.jquery.min.js"></script>
<!-- plugin for gallery image view -->
<script src="../others/charisma/bower_components/colorbox/jquery.colorbox-min.js"></script>
<!-- notification plugin -->
<script src="../others/charisma/js/jquery.noty.js"></script>
<!-- library for making tables responsive -->
<script src="../others/charisma/bower_components/responsive-tables/responsive-tables.js"></script>
<!-- tour plugin -->
<script src="../others/charisma/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js"></script>
<!-- star rating plugin -->
<script src="../others/charisma/js/jquery.raty.min.js"></script>
<!-- for iOS style toggle switch -->
<script src="../others/charisma/js/jquery.iphone.toggle.js"></script>
<!-- autogrowing textarea plugin -->
<script src="../others/charisma/js/jquery.autogrow-textarea.js"></script>
<!-- multiple file upload plugin -->
<script src="../others/charisma/js/jquery.uploadify-3.1.min.js"></script>
<!-- history.js for cross-browser state change on ajax -->
<script src="../others/charisma/js/jquery.history.js"></script>
<!-- application script for Charisma demo -->
<script src="../others/charisma/js/charisma.js"></script>
